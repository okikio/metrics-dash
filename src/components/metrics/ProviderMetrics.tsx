    ...
    <CollapsibleCard title="Provider Performance">
      <div className="flex flex-col gap-4">
        <div className="w-full">
          <BarChart title="Provider Status Distribution" data={providerStatusData} />
        </div>

        <div className="flex flex-col md:grid md:grid-cols-3 gap-4">
          <div className="w-full">
            <PieChart title="Provider Tool Distribution" data={providerToolData} />
          </div>
          <div className="w-full md:col-span-2">
            {isMobile ? (
              <BarChart title="Top 10 Provider Failure Rates" data={providerFailuresData10} />
            ) : (
              <BarChart
